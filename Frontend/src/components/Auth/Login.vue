      ...
      <div class="bg-white rounded-lg shadow-2xl p-8 space-y-6">
          ...
          <div class="relative">
            ...
            >
              ...
              <svg v-else class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <path d="M15.171 13.576l1.414 1.414a1 1 0 00.707.293 1 1 0 00.707-1.707l-14-14a1 1 0 00-1.414 1.414l1.473 1.473A10.014 10.014 0 00.458 10c1.274 4.057 5.064 7 10 7a9.958 9.958 0 004.512-1.074l1.781 1.781zm4.065-4.294a1 1 0 00-1.414-1.414L5.13 9.13a1 1 0 101.414 1.414L18.436 9.582z" />
              </svg>
            </button>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          <label class="flex items-center space-x-2">
            <input type="checkbox" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500 cursor-pointer" />
        ...
        <button
          @click="handleLogin"
          :disabled="loading"
          class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:from-gray-400 disabled:to-gray-400 text-white font-bold py-3 px-4 rounded-lg transition duration-200 transform hover:scale-105 active:scale-95"
        >
