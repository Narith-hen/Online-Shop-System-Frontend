        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div class="animate-fade-in-left">
            ...
            <p class="text-gray-600 mb-4 leading-relaxed">
              ...
              selection of products across various categories, from electronics to accessories.
            </p>
            <p class="text-gray-600 leading-relaxed">
              Our commitment to quality, affordability, and excellent customer service remains unwavering, 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="flex gap-4 animate-fade-in-up" style="animation-delay: 0ms">
            ...
            <div>
              ...
              <p class="text-gray-600">Browse thousands of products across multiple categories</p>
            </div>
          </div>
          ...
          <div class="flex gap-4 animate-fade-in-up" style="animation-delay: 80ms">
            ...
            <div>
              ...
              <p class="text-gray-600">Get the best deals and regular discounts on your favorite items</p>
            </div>
          </div>
          ...
          <div class="flex gap-4 animate-fade-in-up" style="animation-delay: 400ms">
            ...
            <div>
              ...
              <p class="text-gray-600">Dedicated customer service team always ready to help</p>
            </div>
          </div>
      ...
      <section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden text-center p-6 animate-fade-in-up" style="animation-delay: 360ms">
            ...
            <p class="text-sm text-gray-500">Dedicated to customer happiness and support</p>
          </div>
